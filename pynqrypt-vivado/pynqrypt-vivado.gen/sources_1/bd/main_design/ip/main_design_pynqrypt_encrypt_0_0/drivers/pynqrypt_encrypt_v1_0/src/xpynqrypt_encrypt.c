...
void XPynqrypt_encrypt_Set_key(XPynqrypt_encrypt *InstancePtr, XPynqrypt_encrypt_Key Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 0, Data.word_0);
    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 4, Data.word_1);
    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 8, Data.word_2);
    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 12, Data.word_3);
}

XPynqrypt_encrypt_Key XPynqrypt_encrypt_Get_key(XPynqrypt_encrypt *InstancePtr) {
    XPynqrypt_encrypt_Key Data;

    Data.word_0 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 0);
    Data.word_1 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 4);
    Data.word_2 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 8);
    Data.word_3 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA + 12);
    return Data;
}

void XPynqrypt_encrypt_Set_nonce(XPynqrypt_encrypt *InstancePtr, XPynqrypt_encrypt_Nonce Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 0, Data.word_0);
    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 4, Data.word_1);
    XPynqrypt_encrypt_WriteReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 8, Data.word_2);
}

XPynqrypt_encrypt_Nonce XPynqrypt_encrypt_Get_nonce(XPynqrypt_encrypt *InstancePtr) {
    XPynqrypt_encrypt_Nonce Data;

    Data.word_0 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 0);
    Data.word_1 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 4);
    Data.word_2 = XPynqrypt_encrypt_ReadReg(InstancePtr->Control_BaseAddress, XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA + 8);
    return Data;
}
