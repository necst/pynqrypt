...
parameter key_c_bitwidth = 128;
parameter nonce_DEPTH = 1;
reg [31 : 0] nonce_OPERATE_DEPTH = 0;
parameter nonce_c_bitwidth = 96;
...
parameter nonce_data_in_addr = 36;
parameter plaintext_length_data_in_addr = 52;
parameter plaintext_data_in_addr = 64;
parameter ciphertext_data_in_addr = 76;
...
reg  BREADY_reg = 0;
reg [key_c_bitwidth - 1 : 0] mem_key [key_DEPTH - 1 : 0] = '{default : 'h0};
...
reg [nonce_c_bitwidth - 1 : 0] mem_nonce [nonce_DEPTH - 1 : 0] = '{default : 'h0};
