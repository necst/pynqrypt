...
`define AUTOTB_DUT      pynqrypt_encrypt
`define AUTOTB_DUT_INST AESL_inst_pynqrypt_encrypt
`define AUTOTB_TOP      apatb_pynqrypt_encrypt_top
`define AUTOTB_LAT_RESULT_FILE "pynqrypt_encrypt.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pynqrypt_encrypt.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pynqrypt_encrypt_top
...
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.pynqrypt_encrypt.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 27751;
parameter LENGTH_ciphertext = 1;
parameter LENGTH_gmem = 2048;
parameter LENGTH_key = 1;
parameter LENGTH_nonce = 1;
