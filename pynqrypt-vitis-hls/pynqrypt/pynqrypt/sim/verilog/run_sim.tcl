...
if {[file isfile pynqrypt_encrypt.autotvin.dat]} {
	file delete -force pynqrypt_encrypt.autotvin.dat
}

if {[file isfile pynqrypt_encrypt.autotvout.dat]} {
	file delete -force pynqrypt_encrypt.autotvout.dat
}
