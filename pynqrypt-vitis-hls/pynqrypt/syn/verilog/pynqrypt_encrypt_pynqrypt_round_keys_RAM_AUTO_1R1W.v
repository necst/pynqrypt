...
`timescale 1ns/1ps
module pynqrypt_encrypt_pynqrypt_round_keys_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 8,
    AddressRange = 176,
    AddressWidth = 8,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        pynqrypt_encrypt_pynqrypt_round_keys_RAM_AUTO_1R1W_memcore pynqrypt_encrypt_pynqrypt_round_keys_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
