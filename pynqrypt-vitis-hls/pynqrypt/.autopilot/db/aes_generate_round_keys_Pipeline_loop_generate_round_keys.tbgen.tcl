set moduleName aes_generate_round_keys_Pipeline_loop_generate_round_keys
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_generate_round_keys_Pipeline_loop_generate_round_keys}
...
set portList { 
	...
	{ pynqrypt_round_keys_we0 sc_out sc_logic 1 signal 0 } 
	{ pynqrypt_round_keys_d0 sc_out sc_lv 8 signal 0 } 
	...
	{ pynqrypt_round_keys_we1 sc_out sc_logic 1 signal 0 } 
	{ pynqrypt_round_keys_d1 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	pynqrypt_round_keys { ap_memory {  { pynqrypt_round_keys_address0 mem_address 1 8 }  { pynqrypt_round_keys_ce0 mem_ce 1 1 }  { pynqrypt_round_keys_we0 mem_we 1 1 }  { pynqrypt_round_keys_d0 mem_din 1 8 }  { pynqrypt_round_keys_q0 in_data 0 8 }  { pynqrypt_round_keys_address1 MemPortADDR2 1 8 }  { pynqrypt_round_keys_ce1 MemPortCE2 1 1 }  { pynqrypt_round_keys_we1 MemPortWE2 1 1 }  { pynqrypt_round_keys_d1 MemPortDIN2 1 8 }  { pynqrypt_round_keys_q1 in_data 0 8 } } }
}
