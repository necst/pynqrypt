...
#define CONTROL_ADDR_PLAINTEXT_LENGTH_DATA 0x30
#define CONTROL_BITS_PLAINTEXT_LENGTH_DATA 64
#define CONTROL_ADDR_PLAINTEXT_DATA        0x3c
#define CONTROL_BITS_PLAINTEXT_DATA        64
#define CONTROL_ADDR_CIPHERTEXT_DATA       0x48
#define CONTROL_BITS_CIPHERTEXT_DATA       64
#define CONTROL_ADDR_KEY_BASE              0x10
#define CONTROL_ADDR_KEY_HIGH              0x1f
#define CONTROL_WIDTH_KEY                  8
#define CONTROL_DEPTH_KEY                  16
#define CONTROL_ADDR_NONCE_BASE            0x20
#define CONTROL_ADDR_NONCE_HIGH            0x2f
#define CONTROL_WIDTH_NONCE                8
#define CONTROL_DEPTH_NONCE                12
