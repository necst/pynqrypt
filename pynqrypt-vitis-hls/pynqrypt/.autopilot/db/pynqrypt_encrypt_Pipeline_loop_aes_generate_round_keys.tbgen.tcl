...
set C_modelArgList {
	...
	{ crypto_aes_sbox_V int 8 regular {array 256 { 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_round_key_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "crypto_aes_sbox_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ crypto_aes_sbox_V_address0 sc_out sc_lv 8 signal 1 } 
	{ crypto_aes_sbox_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ crypto_aes_sbox_V_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "crypto_aes_sbox_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "crypto_aes_sbox_V", "role": "address0" }} , 
 	{ "name": "crypto_aes_sbox_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "crypto_aes_sbox_V", "role": "ce0" }} , 
 	{ "name": "crypto_aes_sbox_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "crypto_aes_sbox_V", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	p_round_key_V { ap_memory {  { p_round_key_V_address0 mem_address 1 6 }  { p_round_key_V_ce0 mem_ce 1 1 }  { p_round_key_V_we0 mem_we 1 1 }  { p_round_key_V_d0 mem_din 1 32 }  { p_round_key_V_q0 mem_dout 0 32 }  { p_round_key_V_address1 MemPortADDR2 1 6 }  { p_round_key_V_ce1 MemPortCE2 1 1 }  { p_round_key_V_we1 MemPortWE2 1 1 }  { p_round_key_V_d1 MemPortDIN2 1 32 }  { p_round_key_V_q1 in_data 0 32 } } }
	crypto_aes_sbox_V { ap_memory {  { crypto_aes_sbox_V_address0 mem_address 1 8 }  { crypto_aes_sbox_V_ce0 mem_ce 1 1 }  { crypto_aes_sbox_V_q0 in_data 0 8 } } }
}
