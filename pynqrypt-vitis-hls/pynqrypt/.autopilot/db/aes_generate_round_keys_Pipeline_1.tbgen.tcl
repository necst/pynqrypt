set moduleName aes_generate_round_keys_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_generate_round_keys_Pipeline_1}
...
set Spec2ImplPortList { 
	this_key { ap_memory {  { this_key_address0 mem_address 1 4 }  { this_key_ce0 mem_ce 1 1 }  { this_key_q0 in_data 0 8 } } }
