...
set portList { 
	...
	{ crypto_aes_sbox_address1 sc_out sc_lv 8 signal 2 } 
	{ crypto_aes_sbox_ce1 sc_out sc_logic 1 signal 2 } 
	{ crypto_aes_sbox_q1 sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "5"],
		...
		"Port" : [
			{"Name" : "pynqrypt_round_keys", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868", "Port" : "pynqrypt_round_keys", "Inst_start_state" : "17", "Inst_end_state" : "18"}]},
			{"Name" : "state", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868", "Port" : "state", "Inst_start_state" : "17", "Inst_end_state" : "18"},
					{"ID" : "5", "SubInstance" : "grp_aes_encrypt_block_Pipeline_2_fu_895", "Port" : "state", "Inst_start_state" : "28", "Inst_end_state" : "29"}]},
			{"Name" : "crypto_aes_sbox", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868", "Port" : "crypto_aes_sbox", "Inst_start_state" : "17", "Inst_end_state" : "18"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.temp_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868", "Parent" : "0", "Child" : ["3", "4"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868.crypto_aes_sbox_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_encrypt_block_Pipeline_loop_aes_encrypt_block_fu_868.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_encrypt_block_Pipeline_2_fu_895", "Parent" : "0", "Child" : ["6"],
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_encrypt_block_Pipeline_2_fu_895.flow_control_loop_pipe_sequential_init_U", "Parent" : "5"}]}
...
set Spec2ImplPortList { 
	...
	crypto_aes_sbox { ap_memory {  { crypto_aes_sbox_address0 mem_address 1 8 }  { crypto_aes_sbox_ce0 mem_ce 1 1 }  { crypto_aes_sbox_q0 in_data 0 8 }  { crypto_aes_sbox_address1 MemPortADDR2 1 8 }  { crypto_aes_sbox_ce1 MemPortCE2 1 1 }  { crypto_aes_sbox_q1 in_data 0 8 } } }
}
