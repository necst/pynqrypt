...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename this_key \
    op interface \
    ports { this_key_address0 { O 4 vector } this_key_ce0 { O 1 bit } this_key_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'this_key'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { pynqrypt_round_keys_address0 { O 8 vector } pynqrypt_round_keys_ce0 { O 1 bit } pynqrypt_round_keys_we0 { O 1 bit } pynqrypt_round_keys_d0 { O 8 vector } } \
} "
} else {
