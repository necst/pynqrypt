...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pynqrypt_encrypt_ctr_encrypt_block_nonce_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pynqrypt_encrypt_ctr_encrypt_block_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename this_nonce \
    op interface \
    ports { this_nonce_address0 { O 4 vector } this_nonce_ce0 { O 1 bit } this_nonce_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'this_nonce'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { plaintext_length_dout { I 64 vector } plaintext_length_num_data_valid { I 3 vector } plaintext_length_fifo_cap { I 3 vector } plaintext_length_empty_n { I 1 bit } plaintext_length_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { plaintext_dout { I 64 vector } plaintext_num_data_valid { I 3 vector } plaintext_fifo_cap { I 3 vector } plaintext_empty_n { I 1 bit } plaintext_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ciphertext_dout { I 64 vector } ciphertext_num_data_valid { I 3 vector } ciphertext_fifo_cap { I 3 vector } ciphertext_empty_n { I 1 bit } ciphertext_read { O 1 bit } } \
} "
}
