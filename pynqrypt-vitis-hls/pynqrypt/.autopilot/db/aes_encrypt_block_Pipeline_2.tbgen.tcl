set moduleName aes_encrypt_block_Pipeline_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_encrypt_block_Pipeline_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ temp int 8 regular {array 16 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ temp_d0 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 4 }  { state_ce0 mem_ce 1 1 }  { state_q0 in_data 0 8 } } }
	temp { ap_memory {  { temp_address0 mem_address 1 4 }  { temp_ce0 mem_ce 1 1 }  { temp_we0 mem_we 1 1 }  { temp_d0 mem_din 1 8 } } }
}
