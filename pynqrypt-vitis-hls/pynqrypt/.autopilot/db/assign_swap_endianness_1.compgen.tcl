...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_i \
    op interface \
    ports { i_dout { I 60 vector } i_num_data_valid { I 3 vector } i_fifo_cap { I 3 vector } i_empty_n { I 1 bit } i_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ciphertext_dout { I 64 vector } ciphertext_num_data_valid { I 4 vector } ciphertext_fifo_cap { I 4 vector } ciphertext_empty_n { I 1 bit } ciphertext_read { O 1 bit } } \
} "
}
