set moduleName assign_swap_endianness_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {assign_swap_endianness.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_read int 128 regular  }
	{ gmem int 128 regular {axi_master 1}  }
	{ i int 60 regular {fifo 0}  }
	{ ciphertext int 64 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "plaintext","offset": { "type": "dynamic","port_name": "plaintext","bundle": "control"},"direction": "READONLY"},{"cName": "ciphertext","offset": { "type": "dynamic","port_name": "ciphertext","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "i", "interface" : "fifo", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i_dout sc_in sc_lv 60 signal 2 } 
	{ i_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ i_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ i_empty_n sc_in sc_logic 1 signal 2 } 
	{ i_read sc_out sc_logic 1 signal 2 } 
	{ ciphertext_dout sc_in sc_lv 64 signal 3 } 
	{ ciphertext_num_data_valid sc_in sc_lv 4 signal 3 } 
	{ ciphertext_fifo_cap sc_in sc_lv 4 signal 3 } 
	{ ciphertext_empty_n sc_in sc_logic 1 signal 3 } 
	{ ciphertext_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "i", "role": "dout" }} , 
 	{ "name": "i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "i", "role": "num_data_valid" }} , 
 	{ "name": "i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "i", "role": "fifo_cap" }} , 
 	...
 	{ "name": "ciphertext_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ciphertext", "role": "num_data_valid" }} , 
 	{ "name": "ciphertext_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ciphertext", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "i_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ciphertext", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	i { ap_fifo {  { i_dout fifo_port_we 0 60 }  { i_num_data_valid fifo_status_num_data_valid 0 3 }  { i_fifo_cap fifo_update 0 3 }  { i_empty_n fifo_status 0 1 }  { i_read fifo_data 1 1 } } }
	ciphertext { ap_fifo {  { ciphertext_dout fifo_port_we 0 64 }  { ciphertext_num_data_valid fifo_status_num_data_valid 0 4 }  { ciphertext_fifo_cap fifo_update 0 4 }  { ciphertext_empty_n fifo_status 0 1 }  { ciphertext_read fifo_data 1 1 } } }
}
