...
__xlx_plaintext_ciphertext__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_plaintext)[i]);
}
  int __xlx_size_param_plaintext = 16384;
  int __xlx_offset_param_plaintext = 0;
  int __xlx_offset_byte_param_plaintext = 0*1;
for (size_t i = 0; i < 16384; ++i){
__xlx_plaintext_ciphertext__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_ciphertext)[i]);
}
