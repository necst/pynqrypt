...
#define XPYNQRYPT_ENCRYPT_CONTROL_ADDR_KEY_DATA              0x10
#define XPYNQRYPT_ENCRYPT_CONTROL_BITS_KEY_DATA              128
#define XPYNQRYPT_ENCRYPT_CONTROL_ADDR_NONCE_DATA            0x24
#define XPYNQRYPT_ENCRYPT_CONTROL_BITS_NONCE_DATA            96
#define XPYNQRYPT_ENCRYPT_CONTROL_ADDR_PLAINTEXT_LENGTH_DATA 0x34
#define XPYNQRYPT_ENCRYPT_CONTROL_BITS_PLAINTEXT_LENGTH_DATA 64
#define XPYNQRYPT_ENCRYPT_CONTROL_ADDR_PLAINTEXT_DATA        0x40
#define XPYNQRYPT_ENCRYPT_CONTROL_BITS_PLAINTEXT_DATA        64
#define XPYNQRYPT_ENCRYPT_CONTROL_ADDR_CIPHERTEXT_DATA       0x4c
