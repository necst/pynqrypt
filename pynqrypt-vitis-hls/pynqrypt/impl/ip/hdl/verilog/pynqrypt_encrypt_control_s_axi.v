...
localparam
    ...
    ADDR_IER                     = 7'h08,
    ADDR_ISR                     = 7'h0c,
    ADDR_KEY_DATA_0              = 7'h10,
    ADDR_KEY_DATA_1              = 7'h14,
    ADDR_KEY_DATA_2              = 7'h18,
    ADDR_KEY_DATA_3              = 7'h1c,
    ADDR_KEY_CTRL                = 7'h20,
    ADDR_NONCE_DATA_0            = 7'h24,
    ADDR_NONCE_DATA_1            = 7'h28,
    ADDR_NONCE_DATA_2            = 7'h2c,
    ADDR_NONCE_CTRL              = 7'h30,
    ADDR_PLAINTEXT_LENGTH_DATA_0 = 7'h34,
    ADDR_PLAINTEXT_LENGTH_DATA_1 = 7'h38,
    ADDR_PLAINTEXT_LENGTH_CTRL   = 7'h3c,
    ADDR_PLAINTEXT_DATA_0        = 7'h40,
    ADDR_PLAINTEXT_DATA_1        = 7'h44,
    ADDR_PLAINTEXT_CTRL          = 7'h48,
    ADDR_CIPHERTEXT_DATA_0       = 7'h4c,
    ADDR_CIPHERTEXT_DATA_1       = 7'h50,
    ADDR_CIPHERTEXT_CTRL         = 7'h54,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_PLAINTEXT_DATA_1: begin
                    rdata <= int_plaintext[63:32];
                end
                ADDR_CIPHERTEXT_DATA_0: begin
                    rdata <= int_ciphertext[31:0];
                end
                ADDR_CIPHERTEXT_DATA_1: begin
                    rdata <= int_ciphertext[63:32];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_plaintext[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_PLAINTEXT_DATA_1)
            int_plaintext[63:32] <= (WDATA[31:0] & wmask) | (int_plaintext[63:32] & ~wmask);
    end
end
...
// int_ciphertext[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        int_ciphertext[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CIPHERTEXT_DATA_1)
            int_ciphertext[63:32] <= (WDATA[31:0] & wmask) | (int_ciphertext[63:32] & ~wmask);
    end
end
