...
module pynqrypt_encrypt_ctr_encrypt_Pipeline_loop_ctr_xor_block15 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] i_46_cast_fu_76_p1;
wire    ap_block_pp0_stage0;
reg   [4:0] i_fu_28;
wire   [4:0] i_16_fu_88_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_fu_82_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        block_addr_reg_121 <= i_46_cast_fu_76_p1;
    end
end
...
assign block_nonce_address0 = i_46_cast_fu_76_p1;

assign block_r_address0 = block_addr_reg_121;

assign block_r_address1 = i_46_cast_fu_76_p1;

assign block_r_d0 = (block_r_q1 ^ block_nonce_q0);

assign i_16_fu_88_p2 = (ap_sig_allocacmp_i_15 + 5'd1);

assign i_46_cast_fu_76_p1 = ap_sig_allocacmp_i_15;

assign icmp_ln50_fu_82_p2 = ((i_46_cast_fu_76_p1 == select_ln23_15) ? 1'b1 : 1'b0);

endmodule //pynqrypt_encrypt_ctr_encrypt_Pipeline_loop_ctr_xor_block15
