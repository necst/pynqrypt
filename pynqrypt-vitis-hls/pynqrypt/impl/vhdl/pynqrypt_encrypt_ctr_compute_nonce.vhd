...
entity pynqrypt_encrypt_ctr_compute_nonce is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pynqrypt_encrypt_ctr_compute_nonce is 
...
attribute shreg_extract : string;
    ...
    signal p_Result_s_fu_22_p3 : STD_LOGIC_VECTOR (127 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= p_Result_s_fu_22_p3;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_Result_s_fu_22_p3, ap_return_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
