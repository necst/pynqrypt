...
entity pynqrypt_encrypt_ctr_xor_block is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pynqrypt_encrypt_ctr_xor_block is 
...
attribute shreg_extract : string;
    ...
    signal xor_ln859_fu_18_p2 : STD_LOGIC_VECTOR (127 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= xor_ln859_fu_18_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, xor_ln859_fu_18_p2, ap_return_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= xor_ln859_fu_18_p2;
        else 
            ap_return <= ap_return_preg;
        end if; 
    end process;

    xor_ln859_fu_18_p2 <= (p_read2 xor p_read);
end behav;
